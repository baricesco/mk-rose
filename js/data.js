...
function mapEntity(r){ return { id:r.id, name:r.name, type:r.type, meter:r.meter||'', ownerName:r.owner_name||'', ownerPhone:r.owner_phone||'', shareEnabled:r.share_enabled!==false, shareToken:r.share_token||'', vacatedAt:r.vacated_at||null }; }
